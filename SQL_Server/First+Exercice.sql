...
--- creation de la table Etudiant avec trois colonnes une 
-- s'appelant Nom avec un varchar(200), l'autre prenom varchar(200) , et la derniere avec l'age en INT

create table etudiant (nom varchar(200),prenom varchar (200), age int)

--- Insertion de 5 lignes dans la table : 
